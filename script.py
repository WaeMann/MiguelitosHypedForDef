...
class ClockWidget(QWidget):
    ...
    def _tick(self):
        ...
        # Fire exactly at the next second boundary to prevent drift
...
def save_order_to_db(order_rows, total, discount_amount=0,
                      cash_paid=None, change_given=None):
    ...
    try:
        ...
        cur.execute(
            "INSERT INTO orders (total, discount_amount, cash_paid, change_given) "
            "VALUES (%s, %s, %s, %s)",
            (total, discount_amount, cash_paid, change_given),
        )
